...
public class HeartRateRestController {
    ...
    public ResponseEntity<String> receiveWatch(@RequestBody HeartRateDataVO watchData) {
    ...
    public ResponseEntity<String> receiveWatchEnd(@RequestBody HeartRateDataVO watchData) {
